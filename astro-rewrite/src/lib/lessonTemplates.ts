/**
 * Lesson Plan Template Configuration
 * Centralized template definitions for Daily, Weekly, Monthly, and Yearly lesson plans.
 */
...
export const DAILY_STAGES: DailyStageConfig[] = [
  { 
    stage: 'Engage', 
    method: '5E', 
    teacherActionsPlaceholder: 'Model sentence structure: She has a sister.', 
    studentActionsPlaceholder: 'Repeat sentence and practice in pairs.', 
    assessmentPlaceholder: 'Collect exit sentence writing.' 
  },
  { 
    stage: 'Explore', 
    method: '5E', 
    teacherActionsPlaceholder: 'Guide discovery of pattern through examples.', 
    studentActionsPlaceholder: 'Identify patterns in sample sentences.', 
    assessmentPlaceholder: 'Quick verbal check: Can students explain the rule?' 
  },
  { 
    stage: 'Explain', 
    method: 'Presentation', 
    teacherActionsPlaceholder: 'Present grammar rule with visuals.', 
    studentActionsPlaceholder: 'Take notes and ask clarification questions.', 
    assessmentPlaceholder: 'Concept check questions.' 
  },
  { 
    stage: 'Elaborate', 
    method: 'Practice → Production', 
    teacherActionsPlaceholder: 'Facilitate pair/group practice activities.', 
    studentActionsPlaceholder: 'Produce sentences in context (role play, writing).', 
    assessmentPlaceholder: 'Monitor and note errors for feedback.' 
  },
  { 
    stage: 'Evaluate', 
    method: 'Production Check', 
    teacherActionsPlaceholder: 'Administer exit ticket or mini-quiz.', 
    studentActionsPlaceholder: 'Complete assessment task independently.', 
    assessmentPlaceholder: 'Collect exit sentence writing.' 
  }
];
